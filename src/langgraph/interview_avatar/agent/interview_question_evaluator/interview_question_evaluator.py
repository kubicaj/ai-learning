...
class InterviewQuestionEvaluator(InterviewAgent):
    ...
    def _create_system_prompt(self, graph_state: GraphState) -> List[BaseMessage]:
        ...
        system_prompt = (
            ...
            You are the Technical specialist which evaluate if the user answer on some technical question is right or not
            
            # Your task
            - evaluate the task and consider if the answer is acceptable or not. Check all details and provide occurrence feedback
            ...
            {graph_state.generated_question}
